function [Click_Detections,Echolocation_clicks_Presence_flag]=Click_Detector(Raw_audio_single_channel,P,Fs,Buffer_size,Plot_flag)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for window_idx=1:floor(Buffer_size/P.T_sec)
         ...
         Y_filtered = filtfilt(P.sos, P.g, Y_window); % Apply bandpass filter within the frequency range specified by the parameters F_low and F_high
         [Locs,Amp,Locs_all,Amp_all]=Transient_selection_glider(Y_filtered,Fs,P);
